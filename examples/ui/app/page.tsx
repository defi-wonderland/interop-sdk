    ...
    <div className='min-h-screen bg-background flex flex-col'>
      ...
      <div className='flex-1 flex flex-col max-w-5xl w-full mx-auto px-4 py-12 sm:px-6 sm:py-16'>
        <div className='flex-1 flex flex-col gap-12'>
          ...
          <div
            className={`grid grid-cols-1 ${enabledApps.length > 1 ? 'md:grid-cols-2' : ''} gap-6 max-w-3xl mx-auto w-full`}
          >
            {enabledApps.map((app) => (
              <Link
                key={app.id}
              ...
              >
                <div className='flex flex-col gap-4'>
                  ...
                  <h2 className='text-2xl font-bold text-text-primary'>{app.title}</h2>
