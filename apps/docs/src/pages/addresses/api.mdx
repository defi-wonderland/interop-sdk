---
title: "Addresses: API Reference"
description: Function signatures and types for the interop-addresses package — high-level helpers, name-layer methods, and binary-layer primitives.
---
