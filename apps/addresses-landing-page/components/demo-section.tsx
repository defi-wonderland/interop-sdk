    ...
    return (
        <section className="px-6 lg:px-16 py-24 bg-gray-50">
            <div className="max-w-5xl">
                <h2 className="font-mono text-4xl font-light mb-8">Interactive Playground</h2>

                <p className="font-mono text-sm text-muted-foreground mb-8 leading-relaxed max-w-2xl">
