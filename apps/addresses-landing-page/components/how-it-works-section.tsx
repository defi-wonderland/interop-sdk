    ...
    return (
        <section id="about" className="px-6 lg:px-16 py-24 bg-gray-50">
            <div className="max-w-5xl mx-auto">
                <h2 className="font-mono text-4xl font-light mb-8">How does it work?</h2>

                <p className="text-md text-gray-600 mb-20 max-w-3xl">
                ...
                <Image
                    ...
                    alt="How it works"
                    className="w-full max-h-screen object-contain px-32"
                    width={1000}
                    height={1000}
                />
            </div>
