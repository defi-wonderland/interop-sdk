...
export function HowItWorksSection() {
    return (
        <section id="about" className="px-6 lg:px-16 py-8 lg:py-10">
            <div className="max-w-5xl mx-auto">
                ...
                <p className="font-mono text-sm md:text-[0.9375rem] lg:text-base text-gray-600 mb-8 md:mb-10 lg:mb-12 max-w-3xl leading-relaxed">
                    ERC-7930 establishes a compact binary Interoperable Address format, while
                    ERC-7828 defines a human-readable Interoperable Name format using ENS and an
